      ...
      <div className="wrapper2">
        <div className="left">
          ...
          <div className="change-images">
            <button className="fa1" onClick={() => prevImage()}>
              <FaArrowAltCircleLeft />
            </button>
            <button className="fa2" onClick={() => nextImage()}>
              <FaArrowAltCircleRight />
            </button>
            {product.image.map((item, imageIndex) => {
              return (
                <div
                  className={index === imageIndex ? "btn2" : "btn"}
                  key={imageIndex}
                ></div>
              );
            })}
        ...
        <div className="right">
          ...
          <div className="quantity-wrapper">
            <div className="quantity">Quantity : {usingContext.quantity}</div>
            <div>
              <button
                className={`qb`}
                onClick={() => usingContext.decQuantity()}
              >
                <FaMinusCircle />
              </button>
              <button className="qb" onClick={() => usingContext.incQuantity()}>
                <FaPlusCircle />
              </button>
            </div>
          </div>
          <div className="buy-buttons-wrapper">
            <div>
              <button
                ...
                onClick={() =>
                  usingContext.onAdd(product, usingContext.quantity)
                }
              >
                Add To Cart
              </button>
            ...
            <div>
              <button className="buy-now" onClick={() => noPayment()}>
                Buy Now
              </button>
            </div>
          </div>
